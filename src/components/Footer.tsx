      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          ...
          <div className="text-center">
            ...
            <div className="mt-2 space-x-4">
              <Link to="/about" className="text-sm hover:text-blue-700 dark:hover:text-blue-400">
                About
              </Link>
              <Link to="/contact" className="text-sm hover:text-blue-700 dark:hover:text-blue-400">
                Contact
              </Link>
              <Link to="/privacy" className="text-sm hover:text-blue-700 dark:hover:text-blue-400">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-sm hover:text-blue-700 dark:hover:text-blue-400">
                Terms
              </Link>
            </div>
          </div>
        ...
        <div className="text-center mt-4">
          <p className="text-xs text-gray-400 dark:text-gray-500">
            Version 1.0.0 | Built with ❤️ using Vite and Tailwind CSS
          </p>
        </div>
      </div>
    </footer>
